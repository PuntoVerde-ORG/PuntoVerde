...
class SignUpView(CreateView):
	...
	def get_form(self, form_class=None):
		...
		form.fields['username'].widget = forms.TextInput(attrs={'class':'form-control mb-2', 'placeholder':'Nick de Usuario'})
...
class EmailUpdate(UpdateView):
	...
	def get_form(self, form_class=None):
		...
		##Personalizacion en tiempo real del form por defecto
		form.fields['email'].widget = forms.EmailInput(attrs={'class':'form-control mb-2', 'placeholder':'Ingrese su NUEVO Correo'})
		return form
